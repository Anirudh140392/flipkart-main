...
const PerformanceOverviewComponent = () => {
    ...
    const [showActiveTab, setShowActiveTab] = useState(PERFORMANCETABS.CAMPAIGNS);
                ...
                <div className="card">
                    <div className="card-body">
                        <div className="border-bottom py-1 position-relative d-flex justify-content-between">
                            ...
                            <Button style={{ marginLeft: "10px", fontSize: "10px" }} onClick={() => campaignSetter("")}>RESET FILTERS</Button>
                        </div>
                        <TopTabs
